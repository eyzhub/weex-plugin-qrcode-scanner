...
public class PluginQrcodeScannerModule extends WXModule {
    ...
    private static final String TAG = "PluginQrcodeScannerModule";
    ...
    public void show() {
        Log.d(TAG, "Showing!!!");
        Toast.makeText(mWXSDKInstance.getContext(),"Module pluginQrcodeScanner is created sucessfully ",Toast.LENGTH_SHORT).show();
    }
}